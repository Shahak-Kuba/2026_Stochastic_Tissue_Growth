...
# set output "pore-area-vs-t-L400.pdf"
# set xlabel '{/Times-Italic t} [day]'
# set ylabel 'Pore area/initial pore area [-]'
# set title '{/Times-Italic L} = 400 {/Symbol m}m'

# set term png enhanced
# set output "pore-area-vs-t-L400.png"
...
B(t) = 1-(t/tb)**nu
fit B(t) 'pore-coverage-L400.dat' using 1:(1-0.01*$2) every :::0::5 via tb,nu

N = 1000

set samples N

plot 'pore-coverage-L400.dat' using 1:(1-0.01*$2) with points title '' lc rgb 'black' pt 6 pi 1 ps 0.4,\
