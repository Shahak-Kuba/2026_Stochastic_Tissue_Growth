...
# set output "pore-area-vs-t-L200.pdf"
...
B(t) = 1-(t/tb)**nu
fit B(t) 'pore-coverage-L200.dat' using 1:(1-0.01*$2) every ::0::4 via tb,nu

N = 1000

set samples N

plot 'pore-coverage-L200.dat' using 1:(1-0.01*$2):($4/100) with points title '' lc variable pt 6 pi 1 ps 0.4,\
